...
use bletchleyllc\pdffield\assetbundles\pdferrorfield\PdferrorFieldAsset;
...
class Pdferror extends Field
{
    ...
    {
        return Craft::t('pdf-field', 'Pdferror');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'pdf-field/_components/fields/Pdferror_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(PdferrorFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').PdfFieldPdferror(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'pdf-field/_components/fields/Pdferror_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
