...
use bletchley\pdfrenderer\assetbundles\resourceurlfield\ResourceUrlFieldAsset;
 ...
 * @since     1.0.0
 */
class ResourceUrl extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('pdf-renderer', 'ResourceUrl');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'pdf-renderer/_components/fields/ResourceUrl_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ResourceUrlFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').PdfRendererResourceUrl(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'pdf-renderer/_components/fields/ResourceUrl_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
